# ![CHANGEME](img/logo.png)

_One sentence on what the mod does and who it's for._

## Features

_One `###` per feature.__
_Describe the feature, what it does, what's special about it, and the crafting recipe._
_Use screenshots and put them in `img/`._

## Installing

Drop `changeme-<version>.jar` into `mods/`.
...
_Describe in plain language how to change the configuration of the mod._
_Include a gamerules table, if relevant._

| Key | Description |
| --- | --- |
| `gamerulekey` | A short description of what the rule changes. |
